// Dark theme — built from scratch (no `ThemeData.dark()`).
//
// Mirrors the structure of [AppLightTheme] so widgets can be completely
// theme-agnostic; they just read from `Theme.of(context).*` and the right
// colors come out automatically.
...
final class AppDarkTheme {
  ...
  static ThemeData get theme {
    ...
    return ThemeData(
      ...
      // ── App bar: surface, subtle elevation when scrolled ──────────
      ...
      // ── Cards: layered on a dark surface ──────────────────────────
